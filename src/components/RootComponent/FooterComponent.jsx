      ...
      <div className="mx-auto w-full max-w-screen-xl p-6 lg:py-8">
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            ...
            <div>
              ...
              <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="mb-4">
                  <a
                    href="https://github.com/bijan-pradhananga/"
                ...
                <li>
                  <a
                    href="https://www.instagram.com/bijan_pradhananga/"
                    className="hover:underline"
                  >
                    Instagram
                  </a>
        ...
        <div className="hidden sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 sm:justify-center sm:mt-0">
            <a
              href="https://www.facebook.com/bijan.pradhananga"
            ...
            <a
              href="https://discord.com/channels/1237667432500428811/1237667432500428815"
